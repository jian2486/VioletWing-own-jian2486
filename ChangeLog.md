...
- Added information about the [Help Center](https://violetwing.featurebase.app/en/help).
- Completely rewrites the FAQ tab.
- Displaying information about the latest CS2 patch.
